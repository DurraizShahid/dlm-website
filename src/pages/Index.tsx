...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-800 via-emerald-600 to-yellow-500 text-white p-4 sm:p-8">
      <div className="text-center max-w-4xl space-y-8">
        ...
        <p className="text-lg sm:text-2xl text-white animate-fade-in-up delay-200">
          Funding. Recognition. Opportunity. Don’t Miss Out.
        </p>
        <p className="text-md sm:text-xl text-white animate-fade-in-up delay-400">
