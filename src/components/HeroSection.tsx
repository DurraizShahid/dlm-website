...
const HeroSection = () => {
  return (
    <section className="text-center max-w-4xl space-y-8 py-16 px-4 sm:py-24 sm:px-8">
      <h1 className="text-4xl sm:text-6xl font-extrabold leading-tight tracking-tight animate-fade-in-up text-white">
