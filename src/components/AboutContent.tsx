  ...
  const values = [
    {
      ...
      title: translate("Fairness"),
      description: translate("Every idea counts, regardless of background or connections."),
    ...
    },
    {
      ...
      description: translate("A clear process with no hidden agendas or biases."),
    ...
    },
    {
      ...
      title: translate("Empowerment"),
      description: translate("Beyond funding, we provide mentorship and a spotlight for growth."),
    ...
    <section className="bg-white text-gray-900 py-16 px-4 sm:py-24 sm:px-8 text-center">
      <div className="max-w-5xl mx-auto space-y-12">
        <h1 className="text-4xl sm:text-6xl font-extrabold leading-tight tracking-tight mb-8">
          {translate("We Believe in the Power of Ordinary People with Extraordinary Ideas.")}
        </h1>
        ...
        <div className="text-left space-y-6 max-w-3xl mx-auto">
          <p className="text-lg sm:text-xl text-gray-700">
            {translate("DLM started with one belief: talent is everywhere, but opportunity is not. Our mission is to break the cycle where only a privileged few get a chance. We are dedicated to finding and nurturing the raw potential within Pakistan's everyday dreamers.")}
          </p>
          ...
          <p className="text-xl sm:text-2xl font-bold text-green-600">
            {translate("This is about leveling the playing field and giving everyone a fair shot.")}
          </p>
          <p className="text-lg sm:text-xl italic opacity-90 text-gray-600">
        ...
        <div className="pt-12">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8">{translate("Our Core Values")}</h2>
        ...
        <div className="pt-12">
          <Link to="/apply" onClick={() => trackInitiateApplication('about')}>
            <Button className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-3 px-8 sm:py-4 sm:px-10 rounded-full text-lg sm:text-xl shadow-lg transform transition-all duration-300 ease-in-out hover:scale-105 focus:outline-none focus:ring-4 focus:ring-yellow-400 focus:ring-opacity-75">
              {translate("Join the Movement – Apply Today")}
            </Button>
          </Link>
